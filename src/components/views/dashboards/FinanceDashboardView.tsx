    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-5 card-3d flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold px-2.5 py-0.5 rounded-full bg-emerald-100 text-emerald-800 border border-emerald-200 badge-3d">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-4 py-2.5 rounded-lg text-xs font-bold bg-indigo-600 hover:bg-indigo-700 text-white transition flex items-center gap-1.5 cursor-pointer shadow-xs btn-3d"
          >
            <ShieldAlert className="w-4 h-4" /> Finance Approvals ({pendingFinanceQueue.length})
          </button>
          <button
            onClick={() => setActiveView('fulfillment')}
            className="px-3.5 py-2.5 rounded-lg text-xs font-bold bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 shadow-2xs transition flex items-center gap-1.5 cursor-pointer btn-3d"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-white rounded-xl border border-slate-200 p-5 card-3d">
