      ...
      <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-2xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1 font-medium">
            Central hub, links out to every module below. Logged in as <span className="text-slate-900 font-bold">{currentUser?.name || 'Sales Representative'}</span>.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3.5 py-2 rounded-lg text-xs font-bold bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 shadow-2xs transition flex items-center gap-1.5 cursor-pointer"
          >
