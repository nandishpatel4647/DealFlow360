      ...
      <div className="bg-white rounded-xl border border-slate-200 p-5 card-3d flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-extrabold tracking-tight text-slate-900 font-sans">
              Sales Governance & Approvals
            </h1>
            <span className="text-xs font-bold px-2.5 py-0.5 rounded-full bg-purple-100 text-purple-800 border border-purple-200 badge-3d">
              Commercial Review
            </span>
          </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-4 py-2.5 rounded-lg text-xs font-bold bg-amber-600 hover:bg-amber-700 text-white transition flex items-center gap-1.5 cursor-pointer shadow-xs btn-3d"
          >
